""" This script downloads OUI file and populate a sqlitedb
"""
...
def get_mac_table_file(filename="oui/oui.txt"):
...
def parse_mac_table_file(filename="oui/oui.txt"):
    ven_arr = []
...
def list_to_database(ven_arr, filename="oui/macvendors1.db"):
    try:
        os.unlink(filename)
    except OSError:
        pass
